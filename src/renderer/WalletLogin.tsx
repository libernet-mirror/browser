...
export const Page = ({
  ...
  return (
    <div className="mx-10 my-40">
      <form
        className="mx-auto max-w-xl min-w-md"
        onSubmit={async (e) => {
          e.preventDefault();
          setUnlocking(true);
          try {
        ...
        <div className="flex">
          ...
          <button
            ...
            className={clsx(
              ...
              "rounded-lg",
              canSubmit
                ? "rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
